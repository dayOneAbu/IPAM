      ...
      <div className="flex items-center justify-between space-y-2">
        <div>
          ...
          <p className="text-muted-foreground">
            Based on the range of LAN and Tunnel Ranges, districts are grouped together
          </p>
        </div>
        <Link href={`cluster/new`} className="space-y-1">
          <Button variant="default" className="w-44 my-1 justify-start">
            <Plus className="text-white mx-2 h-8 w-4" />  Add New Cluster
          </Button>
        </Link>
      </div>
