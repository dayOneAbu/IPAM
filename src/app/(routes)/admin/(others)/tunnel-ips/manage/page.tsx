...
export const manageTunnelIps = z.object({
  ...
  to: z
    .string({ required_error: "please set ending TunnelIp" }),
  district: z
...
export default function ManageTunnel() {
  ...
  const form = useForm<z.infer<typeof manageTunnelIps>>({
    resolver: zodResolver(manageTunnelIps),
    progressive: true,
  ...
  const allTunnel = api.tunnelIps.getByDistrict.useQuery(
  ...
  function onSubmit(values: z.infer<typeof manageTunnelIps>) {
  ...
  return (
    <div className="mx-4 py-6">
      ...
      <div className="space-y-2 mb-5 mx-6">
        <h2 className="text-2xl max-w-3xl font-bold tracking-tight">Manage TunnelIps</h2>
        <p className="text-muted-foreground break-words">
          Here&apos;s a list of  Tunnel Ips you can select range of ip address and make them either reserved or flagged, which makes the selected ips un-usable.
      ...
      <FormProvider {...form}>
        <div className={cn("min-w-5xl mt-5 pt-8 my-auto mx-6 px-8")} >
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-w-3xl">
            ...
            {allTunnel.isFetching && (<Loading text="available Tunnel Ips" />)}
            {allTunnel.data && (
              <div className="flex gap-2 mx-auto flex-row items-center justify-between max-w-4xl">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col">
                      <FormLabel>Starting Tunnel Ip Address</FormLabel>
                          ...
                          <FormControl>
                            ...
                            >
                              {field.value
                                ...
                                : "Select Starting Tunnel Ip Address"}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col">
                      <FormLabel>Ending Tunnel Ip Address</FormLabel>
                          ...
                          <FormControl>
                            ...
                            >
                              {field.value
                                ...
                                : "Select Ending Tunnel Ip Address"}
                              <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                            </Button>
                          </FormControl>
                        </PopoverTrigger>
